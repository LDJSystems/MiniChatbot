    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vector_busqueda', django.contrib.postgres.search.SearchVectorField(editable=False)),
                ('creado_en', models.DateTimeField(auto_now_add=True)),
                ('actualizado_en', models.DateTimeField(auto_now=True)),
            ],
            options={
                'db_table': 'base_conocimiento',
                'indexes': [models.Index(fields=['provincia'], name='idx_bc_provincia'), models.Index(fields=['campo_estudio'], name='idx_bc_campo'), models.Index(fields=['colectivo'], name='idx_bc_colectivo'), django.contrib.postgres.indexes.GinIndex(fields=['vector_busqueda'], name='idx_bc_fts_gin')],
            },
        ),
        migrations.CreateModel(
            name='StagingCursos',
            ...
            options={
                ...
                'indexes': [models.Index(fields=['estado'], name='idx_staging_estado')],
            },
        ),
    ]
